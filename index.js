...
console.log("\t\t", chalk.black.bgBlueBright(" WELLCOME CODE TO 'OOP MY BANK'  "));
    ...
    do {
        ...
        if (service.select == "View Balance") {
            ...
            if (account) {
                ...
                console.log(`\n\t\t>>> Dear ${chalk.green.bold(name?.firstName)} ${chalk.green.bold(name?.lastName)} your account balance is ${chalk.bold.blue(`$${account.balance}`)}`);
            }
        }
